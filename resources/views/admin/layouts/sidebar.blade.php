    ...
    <nav class="p-4 space-y-2">
        ...
        <div class="space-y-1">
            <button type="button"
                ...
                class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-lg transition group {{ request()->routeIs('admin.categories.*') || request()->routeIs('admin.products.*') || request()->routeIs('admin.formats.*') || request()->routeIs('admin.orders.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <svg id="shop-dropdown-arrow" class="w-4 h-4 transition-transform duration-200 {{ request()->routeIs('admin.categories.*') || request()->routeIs('admin.products.*') || request()->routeIs('admin.formats.*') || request()->routeIs('admin.orders.*') ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>

            <div id="shop-dropdown" class="{{ request()->routeIs('admin.categories.*') || request()->routeIs('admin.products.*') || request()->routeIs('admin.formats.*') || request()->routeIs('admin.orders.*') ? '' : 'hidden' }} pl-12 space-y-1 mt-1">
                ...
                <a href="{{ route('admin.orders.index') }}" class="block py-2 text-sm transition-colors {{ request()->routeIs('admin.orders.index') ? 'text-blue-600 font-bold' : 'text-gray-600 hover:text-blue-600' }}">
                    Orders
                </a>
            </div>
        </div>
